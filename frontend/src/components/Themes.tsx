...
const Themes: React.FC = () => {
  ...
  return (
    <div className="relative z-50 flex flex-row items-center justify-center my-auto bg-opacity-100">
      <Listbox value={theme} onChange={handleChange}>
        <div className="relative">
          ...
          >
            <Listbox.Options
              className="absolute top-0 right-0 block overflow-y-auto rounded-lg h-72 scrollbar-thin scrollbar-thumb-current scrollbar-track-transparent"
              tabIndex={0}
            >
